...
def get_search_space_par(str_query,state):
    return {
        'query': str_query,
        'expansions' : 'host_ids,creator_id,invited_user_ids,speaker_ids,topic_ids',
        'state': state,
...
#SEARCH TWEETS
def get_recent_tweet_count_par(str_query, end_time, granularity, since_id, start_time, until_id):
    return {
        'query': str_query,
        'end_time': end_time,
